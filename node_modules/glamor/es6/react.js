...
export function createElement(tag, allProps) {
  ...
  if (typeof tag === 'string' && allProps && allProps.css) {
    ...
    var props = _objectWithoutProperties(allProps, ['css']);

    return React.createElement.apply(React, [tag, _extends({}, props, Array.isArray(css) ? merge.apply(undefined, _toConsumableArray(css)) : isLikeRule(css) ? css : style(css))].concat(children));
  }
