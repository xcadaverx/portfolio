        ...
        switch (_context.prev = _context.next) {
          ...
          case 25:
            ...
            plugins = [new _webpack2.default.DefinePlugin({
              ...
              useHashIndex: false
            })].concat(hotReload ? [new _webpack2.default.HotModuleReplacementPlugin(), new _detachPlugin2.default(), new _dynamicEntryPlugin2.default(), new _unlinkFilePlugin2.default(), new _watchRemoveEventPlugin2.default(), new _watchPagesPlugin2.default(dir)] : [new _webpack2.default.optimize.UglifyJsPlugin({
            ...
            return _context.abrupt('return', (0, _webpack2.default)({
              ...
              resolve: {
                root: [nodeModulesDir, (0, _path.join)(dir, 'node_modules')]
              },
              resolveLoader: {
